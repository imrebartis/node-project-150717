...
var mapOptions = {
  center: { lat: 47.5063407, lng: 19.039026899999953 },
  zoom: 10
};

function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 47.5063407;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 19.039026899999953;
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    var markers = places.map(function (place) {
      // the order is placeLng, placeLat coz this is the data coming
      // back from the db
